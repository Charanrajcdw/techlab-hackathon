...
if __name__ == '__main__':
    ...
    title = Paragraph("My Document Title", title_style)
    ...
    body_image_path = "./image.png"  # Path to your body image
    body_image = Image(body_image_path)
    ...
    # Build
    doc = SimpleDocTemplate("my_file_3.pdf", pagesize=LETTER)
